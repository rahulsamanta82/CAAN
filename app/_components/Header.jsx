...
import CAAN from "@/app/_assets/CAAN.png"
            ...
            <div className="w-full flex items-center justify-center">
                <div className="w-full flex items-center justify-between ">
                    <div className="flex items-center justify-center
                      ml-4 ">
                      <Link href="/" className="flex items-center justify-center"><img className=" object-cover overflow-hidden px-[10px] p-[5px] h-[75px]" src={CAAN.src}></img></Link>
                    </div>
                    <div className="hidden sm:flex mx-auto  items-center justify-center flex-row gap-9 uppercase text-md  font-semibold">
                      ...
                      <Link href="/#people"><p className=" hover:text-gray-400 transition ease-in-out duration-500">CAAN Angels</p></Link>
                      <Link href="#"><p className=" hover:text-gray-400 transition ease-in-out duration-500">Annual Report</p></Link>
                      <Link href="#"><p className=" hover:text-gray-400 transition ease-in-out duration-500">E-news</p></Link>
